...
# using data from cuda9.2.yaml

ARG zm_version

FROM nvidia/cuda:9.2-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:9.2-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda9.2

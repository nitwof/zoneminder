...
# using data from cuda10.1-cudnn7.yaml

ARG zm_version

FROM nvidia/cuda:10.1-cudnn7-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:10.1-cudnn7-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda10.1-cudnn7

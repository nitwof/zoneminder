...
# using data from cuda11.0.yaml

ARG zm_version

FROM nvidia/cuda:11.0-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:11.0-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda11.0

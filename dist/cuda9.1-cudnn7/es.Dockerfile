...
# using data from cuda9.1-cudnn7.yaml

ARG zm_version

FROM nvidia/cuda:9.1-cudnn7-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:9.1-cudnn7-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda9.1-cudnn7

...
FROM nvidia/cuda:10.0-cudnn7-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:10.0-cudnn7-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda10.0-cudnn7

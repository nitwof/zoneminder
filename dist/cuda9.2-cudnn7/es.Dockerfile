...
# Fri, 04 Dec 2020 15:39:48 UTC
# using data from cuda9.2-cudnn7.yaml

ARG zm_version

FROM nvidia/cuda:9.2-cudnn7-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:9.2-cudnn7-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda9.2-cudnn7

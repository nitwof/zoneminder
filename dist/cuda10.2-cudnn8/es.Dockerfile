...
# using data from cuda10.2-cudnn8.yaml

ARG zm_version

FROM nvidia/cuda:10.2-cudnn8-devel-ubuntu16.04 AS opencv-build
...
FROM nvidia/cuda:10.2-cudnn8-devel-ubuntu16.04 AS face_recognition-build
...
FROM zoneminder:${zm_version}-cuda10.2-cudnn8
